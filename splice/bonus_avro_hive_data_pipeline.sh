...
EXT_REC_PK_HASH_VALUE='HASH(A.TRADE_ID)'

sudo -su hdfs hive -f "/home/splice/cetera/sqoop/BONUS-TEST/bonus_avro_hive.hql"  --hiveconf EXT_REC_NPK_HASH_VALUE=${EXT_REC_NPK_HASH_VALUE} --hiveconf EXT_REC_PK_HASH_VALUE=${EXT_REC_PK_HASH_VALUE}
