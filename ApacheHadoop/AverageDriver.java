...
public class AverageDriver {
 ...
 public static class SOAverageMapper extends Mapper < Object, Text, IntWritable, CountAverageTuple > {
 ...
 public static class SOAverageReducer extends Reducer < IntWritable, CountAverageTuple, IntWritable, CountAverageTuple > {
  ...
  @Override
  public void reduce(IntWritable key, Iterable < CountAverageTuple > values, Context context) throws IOException,
  InterruptedException {
 ...
 public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
  ...
  if (otherArgs.length != 2) {
   ...
   System.out.println(conf.getFinalParameters().toString());
